...
import { mergeProps, withCtx, createVNode, useSlots, computed, unref, createBlock, createCommentVNode, renderSlot, openBlock, createTextVNode, toDisplayString, Fragment, renderList, useSSRContext } from 'vue';
...
import { _ as _export_sfc, e as __nuxt_component_2, b as useAppConfig, t as tv, c as _sfc_main$j, d as _sfc_main$p } from './server.mjs';
import '../_/nitro.mjs';
import 'node:http';
import 'node:https';
import 'node:events';
...
_sfc_main$1.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.3.0_1d3fc7c86ef224cef22814d795f65c58/node_modules/@nuxt/ui/dist/runtime/components/PageCTA.vue");
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "flex flex-col lg:flex-row" }, _attrs))}>`);
  ...
  _push(ssrRenderComponent(_component_UPageCTA, {
    ui: { container: "px-2 py-8", body: "min-h-1 bg-sky-500", footer: "mt-2" },
    title: "Axel",
...
//# sourceMappingURL=index-Cm5wp-bB.mjs.map
