...
import { defineComponent, shallowRef, h, resolveComponent, computed, unref, mergeProps, withCtx, renderSlot, useSlots, ref, inject, createBlock, createCommentVNode, openBlock, toDisplayString as toDisplayString$1, createVNode, resolveDynamicComponent, toValue, watch, useAttrs, useTemplateRef, hasInjectionContext, getCurrentInstance as getCurrentInstance$1, provide, mergeModels, useModel, createTextVNode, onServerPrefetch, toRef, nextTick, defineAsyncComponent, createElementBlock, cloneVNode, useSSRContext, Suspense, Fragment, createApp, renderList, useId, withModifiers, shallowReactive, onErrorCaptured, reactive, effectScope, isReadonly, isRef, isShallow, isReactive, toRaw, toHandlers, getCurrentScope, markRaw, Text } from 'vue';
import { w as serialize, x as parseQuery, y as klona, z as defuFn, A as defu, B as hasProtocol, C as joinURL, D as isEqual, E as withQuery, F as withTrailingSlash, G as withoutTrailingSlash, H as isScriptProtocol, I as sanitizeStatusCode, J as getContext, K as withLeadingSlash, L as parseURL, r as createError$1, $ as $fetch$1, M as baseURL, N as createHooks, O as executeAsync, P as toRouteMatcher, Q as createRouter$1, R as getRequestURL, S as getCookie, T as getRequestHeader, t as destr, U as createDefu, V as parsePath, W as parse$1, X as setCookie, Y as deleteCookie, Z as encodeParam, _ as encodePath, a0 as isEqual$1 } from '../_/nitro.mjs';
...
import { Primitive, useForwardProps, Slot, ToastProvider, ToastPortal, ToastViewport, ConfigProvider, TooltipProvider, useFilter, useForwardPropsEmits, ComboboxItem, ComboboxLabel, ComboboxSeparator, ComboboxItemIndicator, ComboboxRoot, ComboboxAnchor, ComboboxTrigger, ComboboxPortal, ComboboxContent, FocusScope, ComboboxInput, ComboboxEmpty, ComboboxVirtualizer, ComboboxGroup, ComboboxArrow, AccordionTrigger, AccordionItem, NavigationMenuItem, NavigationMenuTrigger, NavigationMenuLink, NavigationMenuContent, AccordionContent, AccordionRoot, NavigationMenuRoot, NavigationMenuList, NavigationMenuIndicator, NavigationMenuViewport, ToastRoot, ToastTitle, ToastDescription, ToastAction, ToastClose, VisuallyHidden, DialogRoot, DialogContent, DialogTitle, DialogDescription, DialogClose, DialogTrigger, DialogPortal, DialogOverlay, TooltipRoot, TooltipTrigger, TooltipPortal, TooltipContent, TooltipArrow, ProgressRoot, ProgressIndicator } from 'reka-ui';
import { reactivePick, reactiveOmit, createReusableTemplate, useVModel, createSharedComposable, useDebounceFn } from '@vueuse/core';
...
const unhead_pcOD91p_mdjC53dcPLZEEOhV44skVeoLLMMSfIGclaQ = /* @__PURE__ */ defineNuxtPlugin({
  name: "nuxt:head",
  enforce: "pre",
  setup(nuxtApp) {
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-Cm5wp-bB.mjs')
  },
  {
    name: "index___en",
    path: "/en",
  ...
  },
  {
    ...
    component: () => import('./index copy-yjyeLMgO.mjs')
  },
  {
    name: "index copy___ms",
    path: "/ms/index%20copy",
    component: () => import('./index copy-yjyeLMgO.mjs')
  },
  {
    name: "index copy___id",
    path: "/id/index%20copy",
    component: () => import('./index copy-yjyeLMgO.mjs')
  }
];
...
const revive_payload_server_jLiB238JeMGJgZDWIhRCmk1jfu_MbxbglaeHZDkNFSs = /* @__PURE__ */ defineNuxtPlugin({
...
const localeLoaders = {
  en: [
    {
      key: "locale_en_46json_f6985449",
      load: () => import(
        './en-r3_5T_P-.mjs'
        /* webpackChunkName: "locale_en_46json_f6985449" */
      ),
      cache: true
    }
  ],
  ms: [
    {
      key: "locale_ms_46json_e496953b",
      load: () => import(
        './ms-r3_5T_P-.mjs'
        /* webpackChunkName: "locale_ms_46json_e496953b" */
      ),
      cache: true
    }
  ],
  id: [
    {
      key: "locale_id_46json_8b264977",
      load: () => import(
        './id-r3_5T_P-.mjs'
        /* webpackChunkName: "locale_id_46json_8b264977" */
      ),
      cache: true
    }
  ]
...
function createNuxtI18nContext(nuxt, vueI18n, defaultLocale) {
  ...
  const loadMessagesFromServer = async (locale) => {
    ...
    const messages = await $fetch(`${"/_i18n/-j7_IQdw"}/${locale}/messages.json`, { headers });
...
const switch_locale_path_ssr_5ok4oeXck693bmcIbruachkODgglJ7OC9HE83l5JcFM = /* @__PURE__ */ defineNuxtPlugin({
...
const route_locale_detect_vPvSqVfaPa4XwjHL67NFkSI6STpETB4GsxhGSCEFI7U = /* @__PURE__ */ defineNuxtPlugin({
...
const preload_TTEKBZRvl9nDRzjy9QlsPxZJDNtqVKoBUSkTBW7Ngls = /* @__PURE__ */ defineNuxtPlugin({
...
const i18n_3I4IuTuDgkKtUKVdUO4nYSvmMOGm2dShiirgAR1xxvA = /* @__PURE__ */ defineNuxtPlugin({
  name: "i18n:plugin",
  parallel: false,
  async setup(_nuxt) {
    let __temp, __restore;
    ...
    prerenderRoutes(localeCodes.map((locale) => `${"/_i18n/-j7_IQdw"}/${locale}/messages.json`));
...
const colors_giZkGsldmHxXUFTi1w_kiKmpMUkIC18oItC13rbc0UE = /* @__PURE__ */ defineNuxtPlugin(() => {
...
const plugin_KqRr5IIHt1f7GW8C02shcwmbkQq7sugvSuqIAK_ea_I = /* @__PURE__ */ defineNuxtPlugin({
  name: "@nuxt/icon",
  setup() {
...
const ssg_detect_yzPRwkJEvua0VJEtlnSdVedW6a8ApHIhwS4L4ZW5LrQ = /* @__PURE__ */ defineNuxtPlugin({
...
const plugins = [
  unhead_pcOD91p_mdjC53dcPLZEEOhV44skVeoLLMMSfIGclaQ,
  plugin,
  revive_payload_server_jLiB238JeMGJgZDWIhRCmk1jfu_MbxbglaeHZDkNFSs,
  components_plugin_4kY4pyzJIYX99vmMAAIorFf3CnAaptHitJgf7JxiED8,
  switch_locale_path_ssr_5ok4oeXck693bmcIbruachkODgglJ7OC9HE83l5JcFM,
  route_locale_detect_vPvSqVfaPa4XwjHL67NFkSI6STpETB4GsxhGSCEFI7U,
  preload_TTEKBZRvl9nDRzjy9QlsPxZJDNtqVKoBUSkTBW7Ngls,
  i18n_3I4IuTuDgkKtUKVdUO4nYSvmMOGm2dShiirgAR1xxvA,
  colors_giZkGsldmHxXUFTi1w_kiKmpMUkIC18oItC13rbc0UE,
  plugin_server_1VsdcVlQN2tv6RG6Fy0EvkojZKbQX61TrTVJeEFBIfo,
  plugin_KqRr5IIHt1f7GW8C02shcwmbkQq7sugvSuqIAK_ea_I,
  ssg_detect_yzPRwkJEvua0VJEtlnSdVedW6a8ApHIhwS4L4ZW5LrQ
];
...
_sfc_main$v.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.3.0_1d3fc7c86ef224cef22814d795f65c58/node_modules/@nuxt/ui/dist/runtime/components/Icon.vue");
...
const ipxRuntime$lpHzL86KyoRG1q1bosD4B3FhJRxfRbj9umObS167jcU = defineProvider({
...
const imageOptions = {
  ...
  provider: "ipx",
  providers: {
    ["ipx"]: { setup: ipxRuntime$lpHzL86KyoRG1q1bosD4B3FhJRxfRbj9umObS167jcU, defaults: {} }
  }
};
...
const __nuxt_component_2 = Object.assign(_sfc_main$u, { __name: "NuxtImg" });
...
const _sfc_main$t = /* @__PURE__ */ Object.assign({ inheritAttrs: false }, {
  ...
  setup(__props) {
    ...
    const appConfig2 = useAppConfig();
    const ui = computed(() => tv({ extend: tv(theme$k), ...appConfig2.ui?.chip || {} })({
      color: props.color,
      size: size.value,
...
_sfc_main$t.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.3.0_1d3fc7c86ef224cef22814d795f65c58/node_modules/@nuxt/ui/dist/runtime/components/Chip.vue");
...
const _sfc_main$s = /* @__PURE__ */ Object.assign({ inheritAttrs: false }, {
  ...
  setup(__props) {
    ...
    const appConfig2 = useAppConfig();
    const { size } = useAvatarGroup(props);
    const ui = computed(() => tv({ extend: tv(theme$j), ...appConfig2.ui?.avatar || {} })({
      size: size.value
    }));
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (__props.src && !error.value) {
              ssrRenderVNode(_push2, createVNode(resolveDynamicComponent(as.value.img || unref(__nuxt_component_2)), mergeProps({
                src: __props.src,
                alt: __props.alt,
                width: sizePx.value,
                height: sizePx.value
            ...
            return [
              __props.src && !error.value ? (openBlock(), createBlock(resolveDynamicComponent(as.value.img || unref(__nuxt_component_2)), mergeProps({
                key: 0,
                src: __props.src,
                alt: __props.alt,
                width: sizePx.value,
...
_sfc_main$s.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.3.0_1d3fc7c86ef224cef22814d795f65c58/node_modules/@nuxt/ui/dist/runtime/components/Avatar.vue");
...
_sfc_main$r.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.3.0_1d3fc7c86ef224cef22814d795f65c58/node_modules/@nuxt/ui/dist/runtime/components/LinkBase.vue");
...
_sfc_main$q.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.3.0_1d3fc7c86ef224cef22814d795f65c58/node_modules/@nuxt/ui/dist/runtime/components/Link.vue");
...
_sfc_main$p.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.3.0_1d3fc7c86ef224cef22814d795f65c58/node_modules/@nuxt/ui/dist/runtime/components/Button.vue");
...
const _sfc_main$o = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    const ui = computed(() => tv({ extend: tv(theme$g), ...appConfig2.ui?.progress || {} })({
...
_sfc_main$o.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.3.0_1d3fc7c86ef224cef22814d795f65c58/node_modules/@nuxt/ui/dist/runtime/components/Progress.vue");
...
const _sfc_main$n = {
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const ui = computed(() => tv({ extend: tv(theme$f), ...appConfig2.ui?.toast || {} })({
      color: props.color,
      orientation: props.orientation,
...
_sfc_main$n.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.3.0_1d3fc7c86ef224cef22814d795f65c58/node_modules/@nuxt/ui/dist/runtime/components/Toast.vue");
...
const _sfc_main$m = /* @__PURE__ */ Object.assign(__default__$1, {
  ...
  setup(__props) {
    ...
    const ui = computed(() => tv({ extend: tv(theme$e), ...appConfig2.ui?.toaster || {} })({
      position: props.position,
...
_sfc_main$m.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.3.0_1d3fc7c86ef224cef22814d795f65c58/node_modules/@nuxt/ui/dist/runtime/components/Toaster.vue");
...
_sfc_main$l.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.3.0_1d3fc7c86ef224cef22814d795f65c58/node_modules/@nuxt/ui/dist/runtime/components/OverlayProvider.vue");
...
_sfc_main$k.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.3.0_1d3fc7c86ef224cef22814d795f65c58/node_modules/@nuxt/ui/dist/runtime/components/App.vue");
...
const _sfc_main$j = {
  ...
  setup(__props) {
    const props = __props;
    const appConfig2 = useAppConfig();
    const ui = computed(() => tv({ extend: tv(theme$d), ...appConfig2.ui?.container || {} }));
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(unref(Primitive), mergeProps({
        as: __props.as,
...
_sfc_main$j.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.3.0_1d3fc7c86ef224cef22814d795f65c58/node_modules/@nuxt/ui/dist/runtime/components/Container.vue");
...
_sfc_main$i.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.3.0_1d3fc7c86ef224cef22814d795f65c58/node_modules/@nuxt/ui/dist/runtime/components/Slideover.vue");
...
_sfc_main$h.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.3.0_1d3fc7c86ef224cef22814d795f65c58/node_modules/@nuxt/ui/dist/runtime/components/Modal.vue");
...
_sfc_main$g.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.3.0_1d3fc7c86ef224cef22814d795f65c58/node_modules/@nuxt/ui/dist/runtime/components/Drawer.vue");
...
_sfc_main$f.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.3.0_1d3fc7c86ef224cef22814d795f65c58/node_modules/@nuxt/ui/dist/runtime/components/Header.vue");
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<h1 class="font-display text-4xl leading-none capitalize not-sm:hidden"> Eons Adrift </h1></div>`);
}
...
const __nuxt_component_4 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$e, [["ssrRender", _sfc_ssrRender]]), { __name: "AppLogo" });
...
const _sfc_main$d = /* @__PURE__ */ Object.assign({ inheritAttrs: false }, {
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const ui = computed(() => tv({ extend: tv(theme$8), ...appConfig2.ui?.input || {} })({
      type: props.type,
      color: color.value,
      variant: props.variant,
...
_sfc_main$d.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.3.0_1d3fc7c86ef224cef22814d795f65c58/node_modules/@nuxt/ui/dist/runtime/components/Input.vue");
...
const _sfc_main$c = /* @__PURE__ */ Object.assign({ inheritAttrs: false }, {
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const ui = computed(() => tv({ extend: tv(theme$7), ...appConfig2.ui?.selectMenu || {} })({
      color: color.value,
      variant: props.variant,
                    ...
                    return [
                      renderSlot(_ctx.$slots, "item", {
                        ...
                        renderSlot(_ctx.$slots, "item-leading", {
                          ...
                          isSelectItem(item) && item.icon ? (openBlock(), createBlock(_sfc_main$v, {
                            key: 0,
                            name: item.icon,
                            "data-slot": "itemLeadingIcon",
                            class: ui.value.itemLeadingIcon({ class: [props.ui?.itemLeadingIcon, item.ui?.itemLeadingIcon] })
                          }, null, 8, ["name", "class"])) : isSelectItem(item) && item.avatar ? (openBlock(), createBlock(_sfc_main$s, mergeProps({
                            key: 1,
                            size: item.ui?.itemLeadingAvatarSize || props.ui?.itemLeadingAvatarSize || ui.value.itemLeadingAvatarSize()
                          }, item.avatar, {
                            "data-slot": "itemLeadingAvatar",
                            class: ui.value.itemLeadingAvatar({ class: [props.ui?.itemLeadingAvatar, item.ui?.itemLeadingAvatar] })
                          }), null, 16, ["size", "class"])) : isSelectItem(item) && item.chip ? (openBlock(), createBlock(_sfc_main$t, mergeProps({
                            key: 2,
                            size: props.ui?.itemLeadingChipSize || ui.value.itemLeadingChipSize(),
                            inset: "",
                            standalone: ""
...
_sfc_main$c.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.3.0_1d3fc7c86ef224cef22814d795f65c58/node_modules/@nuxt/ui/dist/runtime/components/SelectMenu.vue");
      ...
      _push(ssrRenderComponent(_sfc_main$c, mergeProps({
        ...
        leading: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            return [
              ...
              }, toDisplayString$1(getEmojiFlag(modelValue.value)), 1)) : createCommentVNode("", true)
            ];
          }
        }),
        "item-leading": withCtx(({ item }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            return [
              createVNode("span", { class: "size-5 text-center" }, toDisplayString$1(getEmojiFlag(item.code)), 1)
            ];
          }
        }),
        _: 1
...
_sfc_main$b.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.3.0_1d3fc7c86ef224cef22814d795f65c58/node_modules/@nuxt/ui/dist/runtime/components/locale/LocaleSelect.vue");
...
_sfc_main$a.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.3.0_1d3fc7c86ef224cef22814d795f65c58/node_modules/@nuxt/ui/dist/runtime/components/color-mode/ColorModeButton.vue");
...
const _sfc_main$9 = {
  ...
  setup(__props) {
    ...
    const { orientation, size: fieldGroupSize } = useFieldGroup(props);
    const { isLeading, isTrailing, leadingIconName, trailingIconName } = useComponentIcons(props);
    const ui = computed(() => tv({ extend: tv(theme$6), ...appConfig2.ui?.badge || {} })({
      color: props.color,
      variant: props.variant,
...
_sfc_main$9.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.3.0_1d3fc7c86ef224cef22814d795f65c58/node_modules/@nuxt/ui/dist/runtime/components/Badge.vue");
...
const _sfc_main$8 = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    const arrowProps = toRef(() => props.arrow);
    const ui = computed(() => tv({ extend: tv(theme$5), ...appConfig2.ui?.popover || {} })({
...
_sfc_main$8.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.3.0_1d3fc7c86ef224cef22814d795f65c58/node_modules/@nuxt/ui/dist/runtime/components/Popover.vue");
...
_sfc_main$7.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.3.0_1d3fc7c86ef224cef22814d795f65c58/node_modules/@nuxt/ui/dist/runtime/components/Kbd.vue");
...
_sfc_main$6.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.3.0_1d3fc7c86ef224cef22814d795f65c58/node_modules/@nuxt/ui/dist/runtime/components/Tooltip.vue");
...
const _sfc_main$5 = /* @__PURE__ */ Object.assign({ inheritAttrs: false }, {
  ...
  setup(__props, { emit: __emit }) {
    ...
    const ui = computed(() => tv({ extend: tv(theme$2), ...appConfig2.ui?.navigationMenu || {} })({
      orientation: props.orientation,
...
_sfc_main$5.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.3.0_1d3fc7c86ef224cef22814d795f65c58/node_modules/@nuxt/ui/dist/runtime/components/NavigationMenu.vue");
...
_sfc_main$4.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.3.0_1d3fc7c86ef224cef22814d795f65c58/node_modules/@nuxt/ui/dist/runtime/components/Main.vue");
...
_sfc_main$3.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.3.0_1d3fc7c86ef224cef22814d795f65c58/node_modules/@nuxt/ui/dist/runtime/components/Footer.vue");
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const uiLocale = computed(() => {
      return supportedLocales[locale.value];
    });
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_NuxtLink = __nuxt_component_0$2;
      const _component_AppLogo = __nuxt_component_4;
      const _component_ULocaleSelect = _sfc_main$b;
      ...
      _push(ssrRenderComponent(_component_UApp, mergeProps({ locale: unref(uiLocale) }, _attrs), {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_UHeader, {
              ...
              title: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(_component_NuxtLink, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(ssrRenderComponent(_component_AppLogo, { class: "h-6 w-auto shrink-0" }, null, _parent4, _scopeId3));
                      } else {
                        return [
                          createVNode(_component_AppLogo, { class: "h-6 w-auto shrink-0" })
                        ];
                      }
                    }),
                    _: 1
              ...
              right: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(_component_ULocaleSelect, {
                    variant: "ghost",
                    "label-key": "code",
                    "model-value": unref(locale),
                    locales: Object.values(supportedLocales),
                    "onUpdate:modelValue": (value) => unref(setLocale)(value)
                  }, null, _parent3, _scopeId2));
            ...
            _push2(ssrRenderComponent(_component_UMain, { class: "max-w-6xl sm:mx-2" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
            ...
            _push2(ssrRenderComponent(_component_UFooter, { class: "max-w-6xl sm:mx-2" }, {
              left: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p class="text-muted text-sm"${_scopeId2}> © ${ssrInterpolate((/* @__PURE__ */ new Date()).getFullYear())} • Axel </p>`);
                } else {
                  return [
                    createVNode("p", { class: "text-muted text-sm" }, " © " + toDisplayString$1((/* @__PURE__ */ new Date()).getFullYear()) + " • Axel ", 1)
                  ];
                }
              }),
              right: withCtx((_2, _push3, _parent3, _scopeId2) => {
            ...
            return [
              ...
              createVNode(_component_UMain, { class: "max-w-6xl sm:mx-2" }, {
                default: withCtx(() => [
                  createVNode(_component_NuxtPage)
                ]),
                _: 1
              }),
              createVNode(_component_UFooter, { class: "max-w-6xl sm:mx-2" }, {
                left: withCtx(() => [
                  createVNode("p", { class: "text-muted text-sm" }, " © " + toDisplayString$1((/* @__PURE__ */ new Date()).getFullYear()) + " • Axel ", 1)
                ]),
                right: withCtx(() => [
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-BpMHx6cw.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-Ddu5JZlb.mjs'));
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/nuxt@4.2.2_@parcel+watcher@_0593db14f52d0201748232d75248b577/node_modules/nuxt/dist/app/components/nuxt-error-page.vue");
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/nuxt@4.2.2_@parcel+watcher@_0593db14f52d0201748232d75248b577/node_modules/nuxt/dist/app/components/nuxt-root.vue");
...
export { _export_sfc as _, __nuxt_component_0$2 as a, useAppConfig as b, _sfc_main$j as c, _sfc_main$p as d, entry_default as default, __nuxt_component_2 as e, _sfc_main$v as f, getSlotChildrenText as g, _sfc_main$q as h, tv as t, useHead as u };
