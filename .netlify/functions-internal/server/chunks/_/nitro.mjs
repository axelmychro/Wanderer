...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "1bc389fe-4941-48ce-be71-203f0ee33b27",
  ...
  en: [
    {
      ...
      load: () => import('./en.mjs' /* webpackChunkName: "locale_en_46json_f6985449" */),
      cache: true
    }
  ],
  ms: [
    {
      ...
      load: () => import('./ms.mjs' /* webpackChunkName: "locale_ms_46json_e496953b" */),
      cache: true
    }
  ],
  id: [
    {
      ...
      load: () => import('./id.mjs' /* webpackChunkName: "locale_id_46json_8b264977" */),
      cache: true
    }
  ]
};
...
const _mGqTzQenvatjzXEnWFODxiW2tB8I6krm_1BWsuxv2ug = defineNitroPlugin(async (nitro) => {
  const runtimeI18n = useRuntimeI18n();
  ...
  nitro.hooks.hook("render:before", async ({ event }) => {
    ...
    if (!url.pathname.includes("/_i18n/-j7_IQdw") && !isExistingNuxtRoute(path)) {
      return;
    }
...
const _xZZPRxUFncXDLIlUuFWhUxX4yxESk_fxeqIhYUAN2UI = (function(nitro) {
...
const plugins = [
  _mGqTzQenvatjzXEnWFODxiW2tB8I6krm_1BWsuxv2ug,
_xZZPRxUFncXDLIlUuFWhUxX4yxESk_fxeqIhYUAN2UI
];
...
const _DdAA4n = defineCachedEventHandler(async (event) => {
  const url = getRequestURL(event);
  if (!url)
...
const _YUegB4 = _messagesHandlerCached;

const _5yVCk_ = lazyEventHandler(() => {
...
const _lazy_KuYfB1 = () => import('../routes/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_KuYfB1, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/api/_nuxt_icon/:collection', handler: _DdAA4n, lazy: false, middleware: false, method: undefined },
  { route: '/_i18n/:hash/:locale/messages.json', handler: _YUegB4, lazy: false, middleware: false, method: undefined },
  { route: '/_ipx/**', handler: _5yVCk_, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_KuYfB1, lazy: true, middleware: false, method: undefined }
];
...
export { $fetch$1 as $, defu as A, hasProtocol as B, joinURL as C, isEqual as D, withQuery as E, withTrailingSlash as F, withoutTrailingSlash as G, isScriptProtocol as H, sanitizeStatusCode as I, getContext as J, withLeadingSlash as K, parseURL as L, baseURL as M, createHooks as N, executeAsync as O, toRouteMatcher as P, createRouter$1 as Q, getRequestURL as R, getCookie as S, getRequestHeader as T, createDefu as U, parsePath as V, parse as W, setCookie as X, deleteCookie as Y, encodeParam as Z, encodePath as _, appRootTag as a, isEqual$1 as a0, buildAssetsURL as b, appRootAttrs as c, appSpaLoaderTag as d, appSpaLoaderAttrs as e, useRuntimeConfig as f, getRouteRulesForPath as g, getResponseStatusText as h, getResponseStatus as i, joinHeaders as j, appId as k, defineRenderHandler as l, appTeleportTag as m, normalizeCookieHeader as n, appTeleportAttrs as o, publicAssetsURL as p, getQuery as q, createError$1 as r, appHead as s, destr as t, useNitroApp as u, getRouteRules as v, serialize$1 as w, parseQuery as x, klona as y, defuFn as z };
